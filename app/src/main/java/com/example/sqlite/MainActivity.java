...
// Link gitHub: https://github.com/DiegoFP96/Certamen4
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> Acategoria = new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,CategoriaS);
        Categoria.setAdapter(Acategoria);
        ArrayAdapter<String> Aubicacion = new ArrayAdapter<>(this,android.R.layout.simple_spinner_item,UbicacionS);
        Ubicacion.setAdapter(Aubicacion);
    }
    ...
    public void RegistrarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if(fila.moveToFirst()){
                Toast.makeText(this, "ID ingresado ya existe", Toast.LENGTH_LONG).show();
        }else{
    ...
    public void ModificarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if (Update == 1){
                Toast.makeText(this, "se actualizo la base de datos correctamente", Toast.LENGTH_LONG).show();
            }else{
                Toast.makeText(this, "No se a encontrado el id", Toast.LENGTH_LONG).show();
            }
        } else {
